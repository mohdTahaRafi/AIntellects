    ...
    def process_and_save(self):
        while True:
            ...
            data = {
                ...
                "green_remaining": remaining_time,
            ...
            if processing_time < 1:
                time.sleep(1 - processing_time)

def main():
    # Initialize video captures
    caps = [
        cv2.VideoCapture(r'D:\Hackathons\Hackofiesta IIITL 2025\AIntellects\backend\videos\sample.mp4'),
        cv2.VideoCapture(r'D:\Hackathons\Hackofiesta IIITL 2025\AIntellects\backend\videos\sample.mp4'),
        cv2.VideoCapture(r'D:\Hackathons\Hackofiesta IIITL 2025\AIntellects\backend\videos\sample.mp4'),
        cv2.VideoCapture(r'D:\Hackathons\Hackofiesta IIITL 2025\AIntellects\backend\videos\sample.mp4')
    ]
